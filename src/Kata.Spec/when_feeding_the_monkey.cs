    ...
    public class when_user_input_has_newline_delimeter
         {
             ...
             It should_return_sum_numbers = () => { _result.Should().Be(6); };
             static Calculator _systemUnderTest;
             static int _result;
         }
    public class when_user_input_has_custom_single_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        Because of = () => { _result = _systemUnderTest.Add("//;\n1;2"); };
        It should_return_sum_numbers = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
